...
Vagrant.configure("2") do |config|
  ...
  config.vm.define "kubemaster" do |kubemaster|
     ...
     kubemaster.vm.network "forwarded_port", guest:8080, host:80

     kubemaster.vm.provider "virtualbox" do |vb|
        vb.memory = "1536"
        vb.cpus = "2"
     end
     kubemaster.vm.provision "shell", path: "providers/main.sh"
  end
  ...
  config.vm.define "kubenode01" do |kubenode01|
     ...
     kubenode01.vm.provision "shell", path: "providers/main.sh"
  end
  ...
  config.vm.define "kubenode02" do |kubenode02|
     ...
     kubenode02.vm.provision "shell", path: "providers/main.sh"
  end
